export default function FinancialControls({
  ...
  // Extracted styles to keep the JSX clean and readable
  const inputStyle = { width: '100%', padding: '0.5rem 0.75rem 0.5rem 1.75rem', fontSize: '0.875rem', border: '1px solid #444', backgroundColor: '#1a1a1a', color: '#FFFFFF', borderRadius: '0.25rem', outline: 'none' };
  const symbolStyle = { position: 'absolute', top: 0, bottom: 0, left: 0, display: 'flex', alignItems: 'center', paddingLeft: '0.75rem', color: '#9CA3AF', fontWeight: '500' };
